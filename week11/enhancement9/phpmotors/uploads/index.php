...
switch ($action) {
    case 'upload':
        ...
        if ($imageCheck) {
            $message = '<p class="">An image by that name already exists.</p>';
        } elseif (empty($invId) || empty($imgName)) {
            $message = '<p class="">You must select a vehicle and image file for the vehicle.</p>';
        } else {
            ...
            if ($result) {
                $message = '<p class="">The upload succeeded.</p>';
            } else {
                $message = '<p class="">Sorry, the upload failed.</p>';
            }
        }
    ...
    case 'delete':
        ...
        if ($remove) {
            $message = "<p class=''>$filename was successfully deleted.</p>";
        } else {
            $message = "<p class=''>$filename was NOT deleted.</p>";
        }
    ...
    default:
        ...
        if (count($imageArray)) {
            ...
            $imageDisplay = '<p class="">Sorry, no images could be found.</p>';
        }
