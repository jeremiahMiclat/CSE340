...
{
    $db = phpmotorsConnect();
    //$sql = 'SELECT * FROM inventory INNER JOIN images ON inventory.invId LIKE images.invId WHERE classificationId IN (SELECT classificationId FROM carclassification WHERE classificationName = :classificationName)';
    $sql = 'SELECT inventory.*, images.*
    FROM inventory
    INNER JOIN images ON inventory.invId LIKE images.invId
...
function getInvItemInfo($invId)
{
    ...
    $sql = 'SELECT inventory.*, images.*
    FROM inventory
    INNER JOIN images ON inventory.invId LIKE images.invId WHERE inventory.invId = :invId
